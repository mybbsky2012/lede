$(document).ready(function () {
    ...
    jQuery.fn.dataTableExt.oSort['volume-asc'] = function (a, b) {  
        ...
        if (a == "--") {
            ...
            var tab = a.split(" ");
            if (tab[1] == "k") x = tab[0];
            if (tab[1] == "Kk") x = tab[0]*1024;
            if (tab[1] == "Mk") x = tab[0]*1048576;
            if (tab[1] == "Gk") x = tab[0]*1073741824;
        }
        ...
        if (b == "--") {
            ...
            var tab = b.split(" ");
            if (tab[1] == "k") y = tab[0];
            if (tab[1] == "Kk") y = tab[0]*1024;
            if (tab[1] == "Mk") y = tab[0]*1048576;
            if (tab[1] == "Gk") y = tab[0]*1073741824;
        }
        return ((x < y) ? -1 : ((x > y) ? 1 : 0));
    };
